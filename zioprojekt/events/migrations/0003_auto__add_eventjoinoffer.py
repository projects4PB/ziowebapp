...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventJoinOffer'
        db.create_table(u'events_eventjoinoffer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserProfile'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('accepted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'events', ['EventJoinOffer'])


    def backwards(self, orm):
        # Deleting model 'EventJoinOffer'
        db.delete_table(u'events_eventjoinoffer')
    ...
    models = {
        ...
        u'events.eventjoinoffer': {
            'Meta': {'object_name': 'EventJoinOffer'},
            'accepted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.UserProfile']"})
        },
        u'offers.offer': {
