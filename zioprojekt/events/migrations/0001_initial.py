...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'events.event': {
            ...
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'event_participants'", 'symmetrical': 'False', 'blank': 'True', 'to': "orm['registration.RegistrationProfile']"})
        },
        'offers.offer': {
