...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_event', (
            ...
            ('moderator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.RegistrationProfile'])),
        ...
        m2m_table_name = db.shorten_name('events_event_participants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['events.event'], null=False)),
            ('registrationprofile', models.ForeignKey(orm['registration.registrationprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['event_id', 'registrationprofile_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('events_event_participants'))
    ...
    models = {
        ...
        'events.event': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moderator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegistrationProfile']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'offer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['offers.Offer']"}),
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'symmetrical': 'False', 'related_name': "'event_participants'", 'blank': 'True', 'to': "orm['registration.RegistrationProfile']"})
        },
        'offers.offer': {
