...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.moderator'
        db.alter_column(u'events_event', 'moderator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.UserProfile']))

    def backwards(self, orm):

        # Changing field 'Event.moderator'
        db.alter_column(u'events_event', 'moderator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.RegistrationProfile']))
    ...
    models = {
        ...
        u'events.event': {
            ...
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'event_participants'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['registration.RegistrationProfile']"})
        },
        u'offers.offer': {
