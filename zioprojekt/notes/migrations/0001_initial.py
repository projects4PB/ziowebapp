...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'events.event': {
            ...
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['registration.RegistrationProfile']", 'null': 'True', 'blank': 'True', 'symmetrical': 'False', 'related_name': "'event_participants'"})
        },
        'notes.note': {
