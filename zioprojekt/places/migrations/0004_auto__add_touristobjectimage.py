...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TouristObjectImage'
        db.create_table(u'places_touristobjectimage', (
        ...
        db.send_create_signal(u'places', ['TouristObjectImage'])


    def backwards(self, orm):
        # Deleting model 'TouristObjectImage'
        db.delete_table(u'places_touristobjectimage')
