...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TouristObject.owner'
        db.add_column(u'places_touristobject', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TouristObject.owner'
        db.delete_column(u'places_touristobject', 'owner_id')
