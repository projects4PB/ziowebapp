...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TouristObjectImage.caption'
        db.alter_column(u'places_touristobjectimage', 'caption', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'TouristObjectImage.caption'
        db.alter_column(u'places_touristobjectimage', 'caption', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        u'places.touristobjectimage': {
            ...
            'caption': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
