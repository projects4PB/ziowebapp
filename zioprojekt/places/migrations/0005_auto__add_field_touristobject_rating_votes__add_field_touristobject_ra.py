...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TouristObject.rating_votes'
        db.add_column(u'places_touristobject', 'rating_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'TouristObject.rating_score'
        db.add_column(u'places_touristobject', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TouristObject.rating_votes'
        db.delete_column(u'places_touristobject', 'rating_votes')

        # Deleting field 'TouristObject.rating_score'
        db.delete_column(u'places_touristobject', 'rating_score')
    ...
    models = {
        ...
        u'places.touristobjectimage': {
            'Meta': {'object_name': 'TouristObjectImage'},
